...
<Card.Root >
	<Card.Content>
		<div class="flex flex-row justify-center items-center pt-4 pb-1">
	...
	<Button
		class="py-[6px] px-[10px] bg-background hover:bg-card dark:hover:bg-muted border flex items-center h-10 my-3"
		on:click={() => {
			localStorage.removeItem('allGeojsonFeatures');
			localStorage.removeItem('activities');
			localStorage.removeItem('heatmapCoords');
			signOut('strava');
		}}
	>
